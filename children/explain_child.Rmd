...
top_three_most_important_vars <- v%>%
  bind_rows()%>%
...
p1<-lapply(params$models_to_explain, function(e){
  ...
  explainer<-fits[[e]][[6]]
  model_profile(explainer, type = "partial",N = 50, variables = predict_vars)
...
p2<-lapply(params$models_to_explain, function(e){
  ...
  explainer<-fits[[e]][[6]]
  model_profile(explainer, type = "conditional", N = 50, variables = predict_vars)
...
p3<-lapply(params$models_to_explain, function(e){
  ...
  explainer<-fits[[e]][[6]]
  model_profile(explainer, type = "accumulated", N = 50, variables = predict_vars)
...
lapply(params$models_to_explain, function(e){
  ...
  explainer<-fits[[e]][[6]]
  a<-model_profile(explainer, type = "accumulated", N = 50, variables = predict_vars)
  a$agr_profiles$`_label_` = "accumulated local"

  b<-model_profile(explainer, type = "conditional", N = 50, variables = predict_vars)
  b$agr_profiles$`_label_` = "local dependence"

  c<-model_profile(explainer, type = "partial", N = 50, variables = predict_vars)
