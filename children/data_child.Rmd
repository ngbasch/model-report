...
# Load functions specific to the model report file
source("scripts/model_report_functions.R",echo = TRUE, local = knitr::knit_global())
...
```{r eda_all_columns, message=FALSE, warning=FALSE, fig.show="hold", fig.width=10,out.width="50%", dpi=300, eval=params$run_visualization}
...
```{r correlation_plot, message=FALSE, warning=FALSE, fig.show="hold", fig.width=10,dpi=300,eval=params$run_visualization}
...
```{r plot_vs_outcome, message=FALSE, warning=FALSE, fig.show="hold", fig.width=10,out.width="50%", dpi=300,eval=params$run_visualization}
...
```{r eda_missing, message=FALSE, warning=FALSE, fig.width=10, fig.height = 5,out.width="100%",eval=params$run_visualization}
# Missing data
